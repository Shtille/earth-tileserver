...
HELP_FILE = help.html
EMPTY_PAGE_FILE = empty_page.html
LIBRARY_DIRS = deps
BINARY_DIRS = src
DIRS_ORDER = \
...
ifeq ($(OS),Windows_NT)
	...
	COPY_EMPTY_PAGE_FILE = if exist $(EMPTY_PAGE_FILE) cp /Y $(EMPTY_PAGE_FILE) $(BINARY_PATH)
else
	...
	COPY_EMPTY_PAGE_FILE = test -f $(EMPTY_PAGE_FILE) && cp $(EMPTY_PAGE_FILE) $(BINARY_PATH)
endif
